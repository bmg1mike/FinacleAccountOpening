...
namespace StanbicIBTC.AccountOpening.Data.Migrations
{
    ...
    [Migration("20220412161853_initialMigration")]
            ...
            modelBuilder.Entity("StanbicIBTC.AccountOpening.Domain.RbxBpmCifCustomDatum", b =>
                {
                    ...
                    b.ToTable("BPM_CIF_CUSTOM_DATA", (string)null);
                });
            ...
            modelBuilder.Entity("StanbicIBTC.AccountOpening.Domain.RbxBpmCorpCifCompany", b =>
                {
                    ...
                    b.ToTable("BPM_CORP_CIF_COMPANY", (string)null);
                });
            ...
            modelBuilder.Entity("StanbicIBTC.AccountOpening.Domain.RbxBpmCorpCifCustomDatum", b =>
                {
                    ...
                    b.ToTable("BPM_CORP_CIF_CUSTOM_DATA", (string)null);
                });
            ...
            modelBuilder.Entity("StanbicIBTC.AccountOpening.Domain.RbxBpmNextOfKinDetail", b =>
                {
                    ...
                    b.ToTable("BPM_NEXT_OF_KIN_DETAILS", (string)null);
                });
            ...
            modelBuilder.Entity("StanbicIBTC.AccountOpening.Domain.RbxRetailsUpdateCustomDatum", b =>
                {
                    ...
                    b.HasKey("CustomerId")
                        .HasName("RETAILS_UPDATE_CUSTOM_DATA_PK");

                    b.ToTable("RETAILS_UPDATE_CUSTOM_DATA", (string)null);
                });
            ...
            modelBuilder.Entity("StanbicIBTC.AccountOpening.Domain.RbxTBvnLinkageLog", b =>
                {
                    ...
                    b.ToTable("T_BVN_LINKAGE_LOG", (string)null);
                });
