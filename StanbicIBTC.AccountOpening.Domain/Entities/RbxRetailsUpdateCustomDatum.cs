...
public partial class RbxRetailsUpdateCustomDatum
{
    ...
    public string NokAddressFormat { get; set; }
    public string NokRelationshipType { get; set; }
    ...
    public string NokPreferredAddress { get; set; }
    public string NokPreferredFormat { get; set; }
    public string NokStateCode { get; set; }
    public string NokStreetName { get; set; }
    public string NokLocalityName { get; set; }
    public string NokAddressCategory { get; set; }
